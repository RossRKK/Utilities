...
public class ItemOmniToolStone extends ItemTool {
    ...
    public ItemOmniToolStone(int par1, EnumToolMaterial par2EnumToolMaterial) {
        super(par1, 2, par2EnumToolMaterial, blocksEffectiveAgainst);
        this.setCreativeTab(CreativeTabs.tabTools);
        this.material = par2EnumToolMaterial;
        this.setMaxDamage(par2EnumToolMaterial.getMaxUses());
        this.setUnlocalizedName(Strings.OMNI_TOOL_STONE_NAME);
    }
    ...
    @Override
   	...
   	public void registerIcons(IconRegister register) {
   		itemIcon = register.registerIcon(Strings.TEXTURE_LOCATION + ":" + Strings.OMNI_TOOL_STONE_NAME);
   	}
}