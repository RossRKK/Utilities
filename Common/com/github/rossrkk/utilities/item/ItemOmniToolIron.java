...
public class ItemOmniToolIron extends ItemTool {
    ...
    public ItemOmniToolIron(int par1, EnumToolMaterial par2EnumToolMaterial) {
        super(par1, 2, par2EnumToolMaterial, blocksEffectiveAgainst);
        this.setCreativeTab(Utilities.utilTab);
        this.material = par2EnumToolMaterial;
        this.setMaxDamage(par2EnumToolMaterial.getMaxUses());
        this.setUnlocalizedName(Strings.OMNI_TOOL_IRON_NAME);
    }
    ...
    @Override
   	...
   	public void registerIcons(IconRegister register) {
   		itemIcon = register.registerIcon(Strings.TEXTURE_LOCATION + ":" + Strings.OMNI_TOOL_IRON_NAME);
   	}
}